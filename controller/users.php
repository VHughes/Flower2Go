...
loadScripts();
    ...
    if(Utils::isPOST()) {
        ...
        if($action == 'delete' && !empty($user_name)) {
            ...
            $newFirstName = $parameters->getValue('firstname');
            $newLastName = $parameters->getValue('lastname');
        ...
        if($rows != null) {
            ...
            foreach($rows as $row) {
                ...
                $html .= "<tr>
                  <td class='first_name'><span>$first_name</span></td><br>
                  <td class='last_name'><span>$last_name</span></td><br>
                  <td class='user_name'><span>$user_name</span></td><br>
                  <td><input id='d-$user_name' class='delete' type='button' value='Delete'/></td><br>
